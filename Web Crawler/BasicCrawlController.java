...
public class BasicCrawlController {
    ...
    private final static String crawlSeed = "http://dailymail.co.uk/";
    private final static int maxPageToFetch = 22000;
    private final static int maxDepthOfCrawling = 16;
    private final static String name = "Sushant Ramesh";
    private final static String id = "3085084700";
    private final static String newssite = "dailymail.co.uk";
